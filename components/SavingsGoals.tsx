                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-black text-sm text-slate-700 dark:text-slate-200">{p1Name}</span>
                            </div>
                            ...
                            <div className="flex items-center justify-between px-2 pt-1">
                                ...
                                <div className="text-right">
                                    <p className="text-[8px] font-black text-slate-400 uppercase">Capacidade aporte</p>
                                    <p className="text-xs font-black text-p1">{formatCurrency(coupleInfo.monthlySavingsP1 || p1Surplus)}/mês</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="space-y-3">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-black text-sm text-slate-700 dark:text-slate-200">{p2Name}</span>
                            </div>
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-slate-50 dark:bg-slate-900/40 p-3 rounded-xl border border-transparent hover:border-slate-200 transition-all">
                                    <p className="text-[9px] font-black text-slate-400 uppercase mb-1">Total no Banco</p>
                            ...
                            <div className="flex items-center justify-between px-2 pt-1">
                                ...
                                <div className="text-right">
                                    <p className="text-[8px] font-black text-slate-400 uppercase">Capacidade aporte</p>
                                    <p className="text-xs font-black text-p2">{formatCurrency(coupleInfo.monthlySavingsP2 || p2Surplus)}/mês</p>
                                </div>
                            </div>
                        </div>
                    </div>
