...
export const AddExpenseModal: React.FC<AddExpenseModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 bg-slate-900/60 flex items-end sm:items-center justify-center z-50 p-4 backdrop-blur-sm animate-in fade-in transition-all">
            <div className="bg-white w-full max-w-md rounded-[2.5rem] p-8 shadow-2xl animate-in slide-in-from-bottom duration-300 relative">
                <button
                    onClick={onClose}
                ...
                {type === ExpenseType.FIXED && initialData && (
                    <div className="mb-6 flex items-center gap-3 bg-blue-50/50 p-4 rounded-2xl border border-blue-100/50">
                        <input
                            type="checkbox"
                            id="onlyThisMonth"
                        ...
                        />
                        <label htmlFor="onlyThisMonth" className="text-xs font-bold text-blue-800 leading-tight cursor-pointer">
                ...
                <form onSubmit={handleFinalSubmit} className="space-y-5">
                    {type === ExpenseType.FIXED && (
                        <div className="space-y-2">
                            <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest px-1">Método de Divisão</label>
                            <div className="flex gap-3 bg-slate-50 p-1 rounded-2xl border border-slate-100">
                                <button
                                    type="button"
                                    onClick={() => setSplitMethod('proportional')}
                                    className={`flex-1 py-3 rounded-xl font-bold text-xs transition-all ${splitMethod === 'proportional' ? 'bg-white shadow-sm text-blue-600 ring-1 ring-slate-200/50' : 'text-slate-400 hover:text-slate-600'}`}
                                >
                                    Proporcional
                                </button>
                                <button
                                    ...
                                    className={`flex-1 py-3 rounded-xl font-bold text-xs transition-all ${splitMethod === 'equal' ? 'bg-white shadow-sm text-blue-600 ring-1 ring-slate-200/50' : 'text-slate-400 hover:text-slate-600'}`}
                                >
                                    50%/50%
                                </button>
                            </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full bg-slate-50 border border-slate-200 focus:border-blue-500 focus:bg-white rounded-2xl pl-10 pr-4 py-4 font-bold text-slate-900 outline-none transition-all"
                                    placeholder="0,00"
                                />
                            </div>
                        </div>
                        <div className="space-y-1">
                            ...
                            <input
                                ...
                                className="w-full bg-slate-50 border border-slate-200 focus:border-blue-500 focus:bg-white rounded-2xl px-5 py-4 font-bold text-slate-900 outline-none transition-all"
                            />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1">
                            ...
                            <select
                                ...
                                className="w-full bg-slate-50 border border-slate-200 focus:border-blue-500 focus:bg-white rounded-2xl px-5 py-4 font-bold text-slate-900 outline-none transition-all appearance-none cursor-pointer"
                            >
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex gap-3 bg-slate-50 p-1.5 rounded-2xl border border-slate-100">
                                <button
                                    ...
                                    className={`flex-1 py-3.5 rounded-xl font-black transition-all ${paidBy === 'person1' ? 'bg-blue-600 text-white shadow-lg' : 'text-slate-400 hover:text-slate-600'}`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-3.5 rounded-xl font-black transition-all ${paidBy === 'person2' ? 'bg-pink-500 text-white shadow-lg' : 'text-slate-400 hover:text-slate-600'}`}
                                >
                    ...
                    <div className="flex gap-3 pt-4">
                        <button
                            type="submit"
                            className="w-full bg-slate-900 text-white font-black py-4.5 rounded-[1.25rem] shadow-xl shadow-slate-200 hover:bg-black active:scale-[0.98] transition-all"
                        >
