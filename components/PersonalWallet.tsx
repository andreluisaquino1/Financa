            ...
            <div className={`flex flex-col lg:row justify-between items-start lg:items-center gap-6 lg:gap-0 bg-white dark:bg-slate-900 p-8 rounded-[2.5rem] border border-slate-100 dark:border-white/5 shadow-2xl shadow-slate-200/50 relative overflow-hidden`}>
                ...
                <div className="flex items-center gap-6 w-full lg:w-auto z-10">
                    ...
                    <button
                        ...
                        className={`flex-1 lg:flex-none ${accentBg} hover:brightness-110 text-white px-10 py-5 rounded-[1.5rem] font-black text-sm shadow-2xl shadow-${person === 'person1' ? 'p1' : 'p2'}/30 transition-all active:scale-95 flex items-center justify-center gap-3 uppercase tracking-widest`}
                    >
                        <span className="text-xl">💳</span> Novo Gasto Individual
                    </button>
                </div>
